...
/*   Updated: 2026/07/30 19:10:50 by aidarsharaf      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
    ...
    std::cout << "  Original Brain address: " << originalDog._brain << std::endl;
    ...
    std::cout << "  Copy Brain address: " << copyDog._brain << std::endl;
    ...
    Dog dog1;
    dog1._brain->ideas[0] = "Dog1: Original idea";
    
    Dog dog2;
    dog2._brain->ideas[0] = "Dog2: Original idea";
    
    std::cout << "Before assignment:" << std::endl;
    std::cout << "  dog1 ideas[0]: " << dog1._brain->ideas[0] << std::endl;
    std::cout << "  dog2 ideas[0]: " << dog2._brain->ideas[0] << std::endl;
    ...
    dog2._brain->ideas[0] = "Dog2: Modified after assignment";
    
    std::cout << "After modifying dog2:" << std::endl;
    std::cout << "  dog1 ideas[0]: " << dog1._brain->ideas[0] << std::endl;
    std::cout << "  dog2 ideas[0]: " << dog2._brain->ideas[0] << std::endl;
    
    if (dog1._brain->ideas[0] != dog2._brain->ideas[0]) {
